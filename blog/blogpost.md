...
First, navigate to the [github repository](https://github.com/transitland/transitland-processing-animation) and follow the relatively painless set-up instructions. Once you have everything set up...
