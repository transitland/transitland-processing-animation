...
if __name__ == "__main__":
    ...
    vehicles_counts_output.to_csv("data/{}_vehicles_count_{}.csv".format(name, frames))
    buses_counts_output.to_csv("data/{}_buses_count_{}.csv".format(name, frames))
    trams_counts_output.to_csv("data/{}_trams_count_{}.csv".format(name, frames))
    metros_counts_output.to_csv("data/{}_metros_count_{}.csv".format(name, frames))
    cablecars_counts_output.to_csv("data/{}_cablecars_count_{}.csv".format(name, frames))
    trains_counts_output.to_csv("data/{}_trains_count_{}.csv".format(name, frames))
    ferries_counts_output.to_csv("data/{}_ferries_count_{}.csv".format(name, frames))
